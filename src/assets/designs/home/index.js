        ...
        <div className='container-fluid bg-primaryColor-shade-300'>
            <header className="bg-white py-5 px-5 logo flex items-center">
                <div className="logo flex items-center gap-6">
                    ...
                    <span className="text-logo text-2xl text-primaryColor-shade-100 font-bold uppercase">
                        Louis Vuitton
                    </span>
                </div>
                <div className="main-menu ml-28">
                    <ul>
                        <li className="text-base text-primaryColor uppercase inline-block mr-14 active">
                            <a href="#">Home</a>
                        </li>
                        <li className="text-base text-primaryColor uppercase inline-block mr-14">
                            <a href="#">Moodboards</a>
                        </li>
                        <li className="text-base text-primaryColor uppercase inline-block mr-14">
            ...
            <div className="body-container p-4">
                <div className="banner-section flex gap-4">
                    <div className="w-1/4">
                    ...
                    <div className="w-4/5">
                        <div className="bg-primaryColor h-[431px] p-4 pb-0 flex justify-between relative">
                            <div className="w-7/12 pt-16 p-5 pr-10 relative">
                                <div className="flex gap-3">
                                    <span className="badge bg-warning font-bold">New</span>
                                    <span className="badge bg-success">Eco-Friendly</span>
                                </div>
                                <h1 className="text-4xl text-white-shade-100 font-bold mt-6 mb-8 leading-[54px]">Men’s Semi-formal Full Set Pack Summer 2022</h1>
                                <div className="flex items-center text-xl text-white-shade-100 gap-5">
                                ...
                                <img src="/images/leef2.png" className="absolute right-[-40px] bottom-0 z-10" alt=""/>
                            </div>
                            <div className="w-5/12 h-full overflow-y-auto auto-scroll relative">
