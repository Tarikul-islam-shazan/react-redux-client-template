...
class QuoteNowCart extends Component {
  ...
  onChangeQuantity = async (productIndex, colorIndex, name, value) => {
    let { cart } = this.state;
    cart[productIndex].colorWiseSizeQuantityPairList[
      colorIndex
    ].sizeQuantityPairList = cart[productIndex].colorWiseSizeQuantityPairList[
      colorIndex
    ].sizeQuantityPairList.map((pair) => {
      if (pair.code === name) {
        pair.quantity = value;
      }
      return pair;
  ...
  render() {
    ...
    return (
      <div className="add-quote d-flex">
        ...
        <div
          className="add-more ml-auto custom-scrollbar"
          id="sidebarCollapse"
          onScroll={this.handleScroll}
        >
          <div
            id="closeRPop"
            className="p-3 cursor-pointer d-inline-block d-xl-none"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20.941"
            ...
            >
              <g
                ...
                transform="translate(1110.29 4909.059)"
              >
                <line
                  id="Line_153"
                  data-name="Line 153"
                ...
                >
                  <g id="reload" transform="translate(-20.982 0)">
                    ...
                    >
                      <path
                        id="Path_27871"
                        data-name="Path 27871"
                        d="M26.048,5.4a10.847,10.847,0,0,1,14.1-.372l-3.228.122a.75.75,0,0,0,.028,1.5h.028l4.956-.183a.749.749,0,0,0,.722-.75V5.623h0l-.183-4.9a.751.751,0,0,0-1.5.056l.117,3.073a12.337,12.337,0,0,0-16.046.433,12.341,12.341,0,0,0-3.712,12.062.747.747,0,0,0,.728.572.65.65,0,0,0,.178-.022.751.751,0,0,0,.55-.906A10.84,10.84,0,0,1,26.048,5.4Z"
                        transform="translate(-20.982 0)"
                        fill="#41487c"
                      />
                      <path
                        id="Path_27872"
                        data-name="Path 27872"
                        d="M98.7,185.786a.749.749,0,1,0-1.456.356,10.839,10.839,0,0,1-17.452,10.9l3.267-.294a.751.751,0,0,0-.139-1.495l-4.939.444a.749.749,0,0,0-.678.817l.444,4.939a.749.749,0,0,0,.745.683.27.27,0,0,0,.067-.006.749.749,0,0,0,.678-.817l-.267-3.006a12.254,12.254,0,0,0,7.129,2.717c.211.011.422.017.628.017A12.339,12.339,0,0,0,98.7,185.786Z"
                        transform="translate(-74.167 -174.923)"
                        fill="#41487c"
                      />
                    </g>
                  </g>
