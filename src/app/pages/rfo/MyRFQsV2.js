...
class MyRFQs extends Component {
    ...
    componentDidMount = async () => {
        document.title =
            "My quote requests with Nitex - The easiest clothing manufacturing software";
        let name = "rfqId";
    ...
    renderList = async (page = 0, merge = false) => {
        ...
        let params = {
            ...
            sort,
            status,
            date: date ? changeDateFormat(date, "", "YYYY-MM-DD") : "",
        };
        ...
        await Http.GET("getRfqListV2", params)
            .then(({ data }) => {
                if (data.myQuotesProductResponses.length > 0) {
                    ...
                    this.setState({
                        rfqList: !merge ? data.myQuotesProductResponses : rfqList,
                        hasNext: false,
                        loading: false,
                    });
                    if (page === 0) {
    ...
    render() {
        ...
        return (
            <LoadingOverlay
                ...
                text={LOADER_TEXT}
            >
                {!hasNext && !rfqList.length ? (
                    <div className="mt-5 not-found">
                        <EmptyState title="Requested quotes not found" />
                        <a
                            className="font-18"
                            // to="/quotes/list"
                            href
                        ...
                        {/* <button className="font-18" onClick={this.renderList(0)}>
                        {" "}
                        Go back
                    </button> */}
                    </div>
                            ...
                            <div className="sort-filter d-flex flex-grow-1">
                                <div className="product-name mr-3">
                                    <input
                                        ...
                                        placeholder="Design title, Collection title..."
                                ...
                                <div className="search mr-3">
                                    <button
                                        className="m-0 btn-brand brand-bg-color shadow border-0"
                                    ...
                                    <div className="collection-name-heading font-24 ml-0 mt-3  mt-sm-0 ml-sm-4">
                                        <ul className="filter-tag m-0 overflow-inherit">
                                            <li className="active">
                                                ...
                                                <div
                                                    className="close-tag"
                                                    onClick={() => this.searchByCollection({})}
                                                >
                                                    <svg
                            ...
                            <div className="selected-item-popup d-flex justify-content-between">
                                ...
                                <div className="close">
                                    <svg
                                        ...
                                        onClick={this.removeTotalSelectedItems}
                                    >
                                        <path
                                            id="close_3_"
                                            data-name="close (3)"
