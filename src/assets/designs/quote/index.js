            ...
            <div className="body-container p-4">
                <div className="filter">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-4 gap-6">
                        <div className="text-base md:text-xl text-white-shade-200 flex  items-center gap-4 sm:gap-8">
                        ...
                        <div className="flex flex-wrap  justify-end gap-4 lg:gap-2">
                            <div className="flex flex-wrap items-center justify-center overflow-x-auto gap-2">
                ...
                <div className="pb-4 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                    <div className="quote-box flex flex-col sm:flex-row  bg-white  p-2">
                        <div className="grid grid-cols-2 gap-1 w-[132px] bg-white">
                            <div className="w-[64px] h-[70px] bg-white-shade-100">
                                <img src={Pant} alt="" className="w-full h-full object-cover object-top"/>
                            </div>
                            <div className="w-[64px] h-[70px] bg-white-shade-100">
                                <img src={Pant} alt="" className="w-full h-full object-cover object-top"/>
                            </div>
                        ...
                        <div className="flex-1 sm:pl-4">
                            <h5 className="font-bold text-xl mb-2 truncate-2">Men’s Semi-formal Full Set Pack Summer 2022</h5>
                            <span className="text-primaryColor-shade-100">NTX/BO/12/12</span>
                            <div className="mt-4 flex justify-between">
                                <span>7 Styles</span>
                                <div className="flex items-center gap-2">
                                    <span className="w-[12px] h-[12px] rounded-full bg-[#DA336F]"></span>
