...
class PayInvoice extends Component {
   ...
   componentDidMount = async () => {
      document.title = "Payment - Nitex - The easiest clothing manufacturing software";
      ...
      return (
         ...
         >
               ...
               <div class="buyer-payment-methods">
                  ...
                  <div className="stepper">
                     <div className="payment-method-type">
                        <div
                           className={`type strip ${paymentMethod === "STRIPE" ? "active" : ""}`}
                              ...
                              <div className="col-md-6">
                                 <div className="form-group m-0">
                                    ...
                                    <input
                                       ...
                                       name="bankSlipDoc"
                                       onChange={(e) => this.onFileUpload(e, "BANK_SLIP")}
                                       className="w-100 border-0"
                                    />
                                    {bankSlipDocError ? (
                                       <span className="error">{bankSlipDocError}</span>
                                    ) : (
                                       ""
                                    )}
                                 </div>
            ...
            <div class={`invoice-summary ${showMblSummary ? `show` : ``}`}>
               <div
                  class="title"
                  onClick={() => this.setState({ showMblSummary: !showMblSummary })}
               >
                  Invoice Summary
               ...
               <div class="details">
                  <h4 class="mb-4 font-weight-normal color-333 font-22">
                  ...
                  <div class="ordered-container">
                     {invoice.itemWisePrice ? (
                        invoice.itemWisePrice.map((item, i) => {
                           return (
                              <div
                                 key={i}
                                 class="mb-2 font-weight-normal color-333 font-18 d-flex align-items-center justify-content-between"
                              >
                                 {item.itemName}
                     ...
                     <div class="mt-5 shipping-info">
                        <div class="mb-2 font-weight-normal color-333 font-18">
                           Shipping <br />
                           <div class="mt-4 color-gray font-16 info-text">
                              Shipping charges and duties might be extra and will be confirmed
                     ...
                     <div class="submit-for-payment d-flex flex-column align-items-center justify-content-center">
                        <button
                           class="btn-brand brand-bg-color shadow m-0 mt-5"
                           onClick={this.submit}
                        >
                           Pay
                        </button>
