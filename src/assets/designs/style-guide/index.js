              ...
              <div className='modal-body relative p-4'>
                <div className='px-4 sm:px-10 xl:px-20 pb-12'>
                  ...
                  <div className='space-y-4'>
                    <p className='text-xl'>
                      Welcome! Sir <strong className='uppercase'>Kavin</strong>.
                      Thanks for joining us!
                    </p>
                    <p className='text-xl'>
                      This is <strong className='uppercase'>Saikat</strong>, a
                      Business Evangelist dedicated to you and your brand.{' '}
                    </p>
                    <p className='text-xl'>
                      We will contact you <strong>within 24 hours </strong>
                    </p>
                    <p className='text-xl'>
