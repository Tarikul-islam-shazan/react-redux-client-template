      ...
      <>
        <>
          {loadingDetails ? (
            ...
            <div className='flex flex-shrink-0 items-center justify-between bg-primaryColor-shade-300 p-6'>
              {task.stepProduct &&
                task.stepProduct.image && (
