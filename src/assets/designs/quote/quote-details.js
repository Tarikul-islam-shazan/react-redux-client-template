    ...
    return (
        <div className='container-fluid bg-primaryColor-shade-300'>
            ...
            <div className="body-container p-4">
                 ...
                 <div className="mb-4">
                     <div className="flex justify-between flex-col sm:flex-row-reverse sm:items-center gap-4">
                            ...
                            <table className='min-w-full'>
                                ...
                                <tbody>
                                    ...
                                    <td className='text-base font-normal border-r border-primaryColor-shade-200 last:border-transparent bg-primaryColor'>
                                        <div className="flex">
                                            <div className="flex flex-col items-center flex-1 gap-2 bg-primaryColor text-white p-4 cursor-pointer border-r border-primaryColor-shade-100">
                                                <span>
                                                    <OkWhite />
                                                </span>
                                                <span>Approve</span>
                                            </div>
                                            <div className="flex flex-col items-center flex-1 gap-2 bg-primaryColor text-white p-4 cursor-pointer">
                                                <span>
                                                    <RefreshWhite />
                                                </span>
                                                <span>Re-cost</span>
