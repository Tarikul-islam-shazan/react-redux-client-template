        ...
        <div className="bg_color_custom">
          ...
          <div className="auth-page container">
                    ...
                    <a href="https://nitex.com" className="back-link back-link-override">
                              <span>
                                 ...
                                 <p> Don't have an account?                          
                                     <Link to="/register" onClick={login} className="text-active text-color_orange" style={{textDecoration: 'underline'}}>Sign Up</Link>
                                 </p>
                               }
                               ...
                               {islogin &&
                                ...
                                <Link to="/login" onClick={register} className="text-active text-color_orange" style={{textDecoration: 'underline'}}>Sign In</Link>
                                 </p>
                               }
              ...
              <div className="row fullscreen">
                  <div className="col-lg-6 col-sm-12 col-md-12 bg_white_auth" style={{padding:0}}>
