                          ...
                          <div className="card">
                              ...
                              </div>
                              {
                                ...
                                <div className="card-body" onClick={this.toggleRfq}>
                                    ...
                                    <a href="/designs/add" className="btn btn-nitex-default">Share your design</a>
                                </div>
                              }
                          ...
                          <div className="card">
                              ...
                              </div>
                              {
                                ...
                                <div className="card-body">
                                    ...
                                    <a href="/designs/explore" className="btn btn-nitex-default">Browse new designs</a>
                                    {/* <a href="/designs/explore" className="btn btn-nitex-default" data-toggle="modal" data-target="#newProject_1_4">Browse new designs</a> */}
                                </div>
                              }
                          </div>
                      </div>
