...
class TaskDashboard extends Component {
    ...
    getTasks = async () => {
        ...
        let pageNumber =
            pagination[selectedTab].currentPage !== undefined
                ? pagination[selectedTab].currentPage + 1
                : 0;
            ...
            >
                <section className="merchandiser-task-section">
                    ...
                    <div className="task-tab-section">
                        ...
                        <div className="merchandiser-task-list">
                                    ...
                                    {!loading ? (
                                        <p>
                                            {this.state[selectedTab]
                                                ? this.state[selectedTab].length
                                                : "--"}{" "}
                                            <span className="bold-font">
                                                / {pagination[selectedTab].totalElements} items
                                            </span>
                                        </p>
                                    ) : (
                                        <></>
                            ...
                            {this.state[selectedTab] &&
                                this.state[selectedTab].map((item, i) => {
                                    return (
                                        <TabItem
                                            item={item}
                                            selectedTab={selectedTab}
                ...
                >
                    <TaskManage
                        ...
                        closeModal={() => this.setState({ showTaskDetailsModal: false })}
                        callback={() => {}}
                    />
                </Modal>
            </LoadingOverlay>
