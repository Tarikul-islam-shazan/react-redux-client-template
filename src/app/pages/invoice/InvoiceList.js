...
class InvoiceList extends Component {
   ...
   componentDidMount = async () => {
      document.title = "My invoices with Nitex - The easiest clothing manufacturing software";
      ...
      await Http.GET("invoiceList", user.id + paramData)
         .then(({ data }) => {
            ...
            if (data.invoiceResponseList) {
               this.setState({
                  invoiceList: merge
                     ? [...invoiceList, ...data.invoiceResponseList]
                     : data.invoiceResponseList,
   ...
   render() {
      ...
      return (
         <section class="admin-invoice-list">
            <div class="header-sorting d-flex flex-column flex-sm-row justify-content-between align-items-center mb-3">
               ...
               <div class="sort-filter collection-list-filter d-flex mt-3 mt-sm-0">
                  <div class="type">
                     <select
                        class="w-100 bg-gray-light border-0"
                        name="status"
                        id="status"
                        value={status}
            ...
            <div class="row">
               <div class="col-12">
                  <table class="table manage-project-table collection-list-table text-center table-responsive-sm">
