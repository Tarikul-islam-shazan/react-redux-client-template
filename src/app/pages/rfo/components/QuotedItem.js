...
export const QuotedItem = ({quote, index, toggleSelect}) => {
  let flag = 1;
  return(
        ...
        <div className="quote-price admin-quote-price d-flex flex-column justify-content-center align-items-center">
            <div className="text-center">
                <span className="font-16">
                    ...
                    within <span className="font-italic font-weight-bold">24 hours</span>
                </span>
                <div className="pricewillbeupdated pt-2 pb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="211" height="54" viewBox="0 0 211 54">
                        <g id="Group_11081" data-name="Group 11081" transform="translate(-1549 -407)">
                            ...
                            <text id="_-----------" data-name="-----------" transform="translate(1604 441)" fill="#aaacaf" font-size="20" font-family="OpenSans, Open Sans" letter-spacing="0.03em"><tspan x="0" y="0">—————</tspan></text>
                        </g>
                    </svg>
                </div>
                ...
                {
                  quote.isSelected ?
                  <button className="m-0 btn-brand m-0 shadow float-right">Place your order</button> :
                  <button className="m-0 btn-brand m-0 shadow float-right" disabled>Place your order</button>
                }
