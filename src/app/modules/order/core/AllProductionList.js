        ...
        <>
            <div className='one-third all-production-details'>
                <div className='factory-view relative mb-5'>
                    ...
                    <button
                        className='btn bg-[#F5F5F5] text-primaryColor absolute right-5 bottom-5 w-[80px] p-4'
                        data-bs-toggle='modal'
            ...
            <div
                className='modal task-conversation fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto'
                id='taskManageModal'
                tabIndex='-1'
                aria-labelledby='exampleModalCenterTitle'
                aria-modal='true'
                role='dialog'
                // onBlur={() => setShowTaskDetailsModal(false)}
            >
                <div className='modal-dialog max-w-[485px] mr-0 mt-0 modal-dialog-centered relative w-auto pointer-events-none'>
                    <div className='modal-content h-screen border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding outline-none text-current'>
