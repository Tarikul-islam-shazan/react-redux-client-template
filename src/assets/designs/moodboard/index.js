          ...
          <div className='moodboard-and-images-layout'>
            <div className='left-half'>
              ...
              <div className='full-moodboard-image'>
                <img src='/images/moodboard/moodboard.jpg' alt='moodboard' />
              </div>
            </div>
            <div className='right-half'>
              {/* Moodboard colors */}
              <div className='moodboard-color-container'>
                ...
                <div className='color-single-item'>
                  <div className='color-view' style={{ background: '#00f851' }}>
                ...
                <div className='color-single-item'>
                  <div className='color-view' style={{ background: '#B08574' }}>
                    <span className='close'>
                      <CloseIcon />
                    </span>
                  </div>
                ...
                <div className='color-single-item'>
                  <div className='color-view' style={{ background: '#3B3738' }}>
                    <span className='close'>
                      <CloseIcon />
                    </span>
                  </div>
                ...
                <div className='color-single-item'>
                  <div className='color-view' style={{ background: '#16505B' }}>
                    <span className='close'>
                      <CloseIcon />
                    </span>
                  </div>
                ...
                <div className='color-single-item'>
                  <div className='color-view' style={{ background: '#6FA7B8' }}>
                    <span className='close'>
                      <CloseIcon />
                    </span>
                  </div>
                ...
                <div className='color-single-item'>
                  <div className='color-view' style={{ background: '#B7B548' }}>
                    <span className='close'>
                      <CloseIcon />
                    </span>
                  </div>
                ...
                <div className='common-color-popup'>
                  ...
                  <div className='common-color-popup-body'>
                    ...
                    <div className='all-available-colors'>
                      <p>Search Result</p>
