         ...
         .then(({ data }) => {
            ...
            if (data) {
               ...
               this.setState({
                  ...
                  proPic:
                     data.profilePicDocument && data.profilePicDocument.docUrl
                        ? data.profilePicDocument.docUrl
                        : "",
            ...
            <section className="profile">
               <div className="profile-tab">
                  <ul className="nav nav-tabs">
                     <li>
                        <a className="active" data-toggle="tab" href="#PersonalInformation">
                     ...
                     <li>
                        <a data-toggle="tab" href="#EmailPreferences">
                           Preferences
                        </a>
                     </li>
                  </ul>
                  <div className="tab-content">
                           ...
                           <div className="user-photo">
                              ...
                              <div className="file btn">
                                 ...
                                 <input
                                    type="file"
                                    name="proPic"
                                    onChange={(e) => this.onFileUpload(e, "PROFILE_PHOTO")}
                                 />
                              </div>
                           </div>
                           <div className="user-info">
                              ...
                              <div className="row">
                                 ...
                                 <div className="col-lg-6">
                                    <div className="form-group">
                                       ...
                                       <input
                                          type="text"
                                          placeholder="Apparel Engineering"
                                          name="department"
                                          onChange={this.onChange}
                                          value={department}
                                       />
                              ...
                              <div className="row mt-4">
                                 <div className="col-lg-12 text-right">
                                    <button className="btn-brand" onClick={this.updateProfile}>
                                       Save Changes
                                    </button>
                                 </div>
                              </div>
                     ...
                     <div id="ChangePassword" className="tab-pane fade">
                        <div className="change-pass">
                           ...
                           <div className="row mt-4">
                              <div className="col-lg-12 text-right">
                                 <button className="btn-brand" onClick={this.updatePassword}>
                                    Save Changes
                                 </button>
                              </div>
                           </div>
                        ...
                        <div className="email-preferences">
                           <div className="stepper">
                              <div className="save-setting d-flex align-items-center mb-4">
                                 ...
                                 <button className="btn-brand" onClick={this.updateEmailPreference}>
                                    Save
                                 </button>
                              </div>
                              <div className="row">
                        ...
                        <div className="address-setting">
                           <div className="stepper">
                              <div className="save-setting d-flex align-items-center mb-4">
                                 ...
                                 <button className="btn-brand" onClick={this.updateAddress}>
                                    Save
                                 </button>
                              </div>
                              <div className="row">
                                 ...
                                 <div className="col-sm-6 col-md-6 col-lg-3">
                                    <div className="form-group">
                                       ...
                                       <input
                                          ...
                                          id="shipping"
                                          name="stateOrProvince"
                                          value={shipping.stateOrProvince}
                                          onChange={this.onChangeAddress}
                                          className="w-100 bg-gray-light border-0"
                                       />
                                    </div>
