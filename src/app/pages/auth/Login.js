...
class Login extends Component {
    ...
    componentDidMount = async () => {
        document.title =
            "Sign in to your account with Nitex - The easiest clothing manufacturing software";
            ...
            >
                ...
                <div className="text-center">
                    <a
                        ...
                        href={GOOGLE_AUTH_URL + (redirection ? "?redirect=" + redirection : "")}
                    >
                        <span>
                ...
                <form className="registration-form" autoComplete="off">
                    ...
                    <button
                        type="button"
                        className="btn btn-nitex-default btn-block"
                        onClick={this.login}
                    >
                        Sign in
                    </button>
