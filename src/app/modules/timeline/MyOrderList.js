        ...
        if (isPageReachBottom()) {
            ...
            if (totalElements > 0) {
                if (totalElements !== data.length) {
                    setLoader(true);
                    let params = generateParams(activeTabName, currentPage + 1, myStateRef.current.searchParam);
    ...
    return (<LoaderComponent loading={loader}>
            <div className="order-list-page-container">
                ...
                <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <span
                            className="search collection-search"
                        >
                    <svg xmlns="http://www.w3.org/2000/svg"
                         width="16.55"
                         height="16.508" viewBox="0 0 16.55 16.508">
                        <path
                            id="Path_23797"
