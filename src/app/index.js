    ...
    return (
      <Router>
        <Switch>
          ...
          <PublicRoute
            exact
            path="/our-design-details"
            component={OurDesignDetails}
          />
