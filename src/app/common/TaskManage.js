...
class TaskManage extends Component {
  ...
  post = async () => {
    let { postType, selectedFiles, taskId, orderId, post, posts } = this.state
    let body = {
            ...
            <Modal.Header>
              ...
              {task.stepProduct && task.stepProduct.id ? (
                <div className='style-name'>
                  of{' '}
                  <a href={`/designs/view/${task.stepProduct.id}`} target='_blank' rel='noreferrer'>
                ...
                <div className='member'>
                      ...
                      >
                        ...
                        <div className='member-list-container'>
                          {orderMemberList && orderMemberList.length ? (
                            orderMemberList.map((member, index) => {
                              return (
                                <div
                  ...
                  {task.memberList && task.memberList.length ? (
                    task.memberList.map((member, index) => {
                      return (
                        <div className='item' key={`task_member_${index}`}>
                          {member.memberImage ? (
                            <img
