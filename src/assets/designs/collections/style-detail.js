...
import { ReactComponent as FavBorderIcon } from '../../images/fav-border.svg';
...
import productLong from "../../images/product/product-long.jpg";
            ...
            <div className="body-container p-4">
                <div className="filter">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-4 gap-6">
                        <div className="flex flex-col">
                           <h2 className="text-px28 font-semibold mb-3">Men’s Semi-formal Full Set Pack Summer 2022</h2>
                            <div className="flex gap-4 items-center">
                                <label>25, Apr 2022</label>
                        ...
                        <div className="flex flex-wrap justify-end gap-4 lg:gap-2">
                            ...
                            <div className="flex flex-wrap items-center overflow-x-auto gap-2">
                                ...
                                <button type="button" data-bs-toggle="modal" data-bs-target="#BriefCollection" className="btn flex w-full sm:w-auto justify-between items-center">
                ...
                <div className="style-details-container grid grid-cols-4 gap-5">
                    <div className="bg-white p-4 relative">
                        ...
                        <img src={productLong} alt="" className="w-full h-full object-contain object-top"/>
                    </div>
                    <div className="bg-white p-4 relative">
                        <div className="absolute left-[15px] top-[15px] bg-white cursor-pointer">
                            <FavBorderIcon />
                    ...
                    <div className="flex flex-col  relative">
                        <div className="h-[280px] overflow-hidden  bg-white p-4 mb-5 relative">
                            <div className="absolute left-[15px] top-[15px] bg-white cursor-pointer">
                                <FavBorderIcon />
                            </div>
                            <img src={Pant} alt="" className="w-full h-full object-contain"/>
                        </div>
                        <div className="h-[280px] overflow-hidden bg-white p-4 mb-5 relative">
                            <div className="absolute left-[15px] top-[15px] bg-white cursor-pointer">
                                <FavBorderIcon />
