                        ...
                        <div className='p-6 xl:p-10 relative flex items-center'>
                            <div>
                                ...
                                <h1 className='text-2xl md:text-4xl text-primaryColor font-bold mt-3  md:leading-[54px]'>
                                    Men’s Semi-formal Full Set Pack Summer 2022
                                </h1>
                                <div className='paragraph-grid-overlay-white relative mb-4'>
                                    <p>
                                        Lorem Ipsum is simply dummy text of the
                                        printing and typesetting industry. Lorem
                                        Ipsum has been the industry&apos;Lorem
                                        Ipsum is simply dummy text of the
                                        printing and typesetting industry. Lorem
                                        Ipsum has been the industry&apos;s stans
                            ...
                            <div>
                                ...
                                <div className='paragraph-grid-overlay-white relative mb-4'>
                                    <p>
                                        Lorem Ipsum is simply dummy text of the
                                        printing and typesetting industry. Lorem
                                        Ipsum has been the industry&apos;Lorem Ipsum
                                        is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has
                                        been the industry&apos;s stans standard dummy
