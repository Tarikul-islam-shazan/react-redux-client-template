...
class ConfirmOrder extends Component {
  ...
  componentDidMount = async () => {
    document.title =
      "Confirm payment - Nitex - The easiest clothing manufacturing software";
  ...
  delete = async (id) => {
    let { order } = this.state;
    let removedItem = order.productResponseList.filter(
      (item) => item.id !== id
    );
    this.setState({
      order: {
  ...
  render() {
    ...
    const onConfirm = async () => {
      ...
      console.log("AMOUNTSSSSSSSSSSSSS", amounts);
    ...
    const onUpdateSizeQuantity = (
      ...
      console.log("SIZE,", sizeId, quantity);
    ...
    console.log("~~~~~", this.state.designLists);
                    ...
                    <div className="uploded-po">
                      <div className="single-po d-flex justify-content-between align-items-center">
                        ...
                        <div className="delete-btn">
                          <img src="../icons/delete_gray.svg" alt="delete" />
                        </div>
                      </div>
                      <div className="single-po d-flex justify-content-between align-items-center">
                        <div className="po-names">
