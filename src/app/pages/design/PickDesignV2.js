                              ...
                              return (
                                 <li className="active" key={i}>
                                    ...
                                    <div
                                       className="close-tag"
                                       onClick={() =>
                                          this.setFilters(filter.type, filter.id, filter.name)
                                       }
                                    >
                                       <svg
                                          xmlns="http://www.w3.org/2000/svg"
                           ...
                           filterOptions.categories.map((item, i) => {
                              return (
                                 <li
                                    ...
                                    key={i}
                                    onClick={() => this.setFilters("CATEGORY", item.id, item.name)}
                                 >
                                    {item.name}
                                 </li>
                              );
                              ...
                              <ul className="list custom-scrollbar" key={i}>
                                 ...
                                 {group.types.map((type, j) => {
                                    return (
                                       <li
                                          style={{
                                             color: isSelected(filters, "PRODUCT_TYPE", type.id)
                                                ? "rgb(238 118 31)"
                                                : "black",
                                          }}
                                          key={j}
                           ...
                           filterOptions.colorResponseList.map((item, i) => {
                              return (
                                 <li
                                    ...
                                    key={i}
                                    onClick={() => this.setFilters("COLOR", item.id, item.name)}
                                 >
                                    {item.name}
                                 </li>
                              );
                        ...
                        {filterOptions.fabricTypeResponseList &&
                           filterOptions.fabricTypeResponseList.map((item, i) => {
                              return (
                                 <li
                                    style={{
                                       color: isSelected(filters, "FABRIC_TYPE", item.id)
                                          ? "rgb(238 118 31)"
                                          : "black",
                                    }}
                                    key={i}
                                    onClick={() =>
                                       this.setFilters("FABRIC_TYPE", item.id, item.name)
                                    }
                                 >
                                    {item.name}
                                 </li>
                  ...
                  <h4 className="mb-4 font-weight-normal">
                     ...
                     <span class="result">
                        {`${pagination.value ? pagination.value : "--"}${
                           pagination.relation && pagination.relation === "GREATER_THAN_OR_EQUAL_TO"
                              ? "+"
                              : ""
                        }`}{" "}
                        Designs
                        ...
                        if (this.getAllAvailableProducts(data.productResponseList).length) {
                           return (
                              <div className="designs" key={i}>
                                 ...
                                 {this.getAllAvailableProducts(data.productResponseList).length >
                                 3 ? (
                                    <Carousel
                                    ...
                                    <div className="show-products">
                                       {this.getAllAvailableProducts(data.productResponseList).map(
                                          (product, j) => {
                                             return (
                                                <ProductCardWithTick
                                                   key={j}
                                       ...
                                       if (banner.banners && banner.banners.length) {
                                          return (
                                             <div className="col-md-6" key={j}>
                                                <a href={"/collections/view/" + banner.id}>
                                                   <img
                                                      src={banner.banners[0].docUrl}
                                                      alt=""
                                 ...
                                 return (
                                    <li key={i}>
                                       ...
                                       <button
                                          class="btn-brand m-0 brand-bg-color"
                                          onClick={() =>
                                             this.addToExistingCollection(collection.id)
                                          }
                                       >
                                          Add
                                       </button>
