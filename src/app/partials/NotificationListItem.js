    ...
    const redirectNotification = async () => {
        ...
        switch (item.category) {
            ...
            case 'STEP':
                ...
                break;
            case 'PRODUCT':
                url += `/designs/view/${relatedEntityId.productId}`;
                // code block
                break;
            case 'COLLECTION':
                url += `/collections/view/${relatedEntityId.collectionId}`;
                // code block
                break;
            case 'INVOICE':
        ...
        >
            <div className="order-approve-notification d-flex justify-content-between">
                    ...
                    <div className="notification-content">
                            ...
                            {item.body &&
                                ...
                                item.body.titlePartList.map((section) => {
                                    ...
                                    if (section.titlePartType === 'PREPOSITION') {
                                        return <span className="sep-text">{` ${section.text} `}</span>;
                                    }
                                    return section.text;
                                })}
                        </p>
                        <ul className="notification-order-info">
                            {item.body &&
                                item.body.entityIdTypeMapList &&
                                item.body.entityIdTypeMapList.map((entity) => {
                                    let relatedEntityId = item.relatedEntityId ? item.relatedEntityId : {};
                                    if (entity.type === 'ORDER') {
                                        return (
                                            <li>
                                                <a
                                                    href="#"
                                                    onClick={(e) => goTo(e, `/orders/view/${entity.id}`)}
                                                >
                                                    {entity.text}
                                                </a>
                                            </li>
                                    ...
                                    if (entity.type === 'PRODUCT') {
                                        return (
                                            <li>
                                                <a
                                                    href="#"
                                                    onClick={(e) => goTo(e, `/designs/view/${entity.id}`)}
                                                >
                                                    {entity.text}
                                                </a>
                                            </li>
                                    ...
                                    if (entity.type === 'COLLECTION') {
                                        return (
                                            <li>
                                                <a
                                                    href="#"
                                                    onClick={(e) => goTo(e, `/collections/view/${entity.id}`)}
                                                >
                                                    {entity.text}
                                                </a>
                                            </li>
                                    ...
                                    if (entity.type === 'INVOICE') {
                                        return (
                                            <li>
                                                <a
                                                    href="#"
                                                    onClick={(e) => goTo(e, `/invoices/view/${entity.id}`)}
                                                >
                                                    {entity.text}
                                                </a>
                                            </li>
                ...
                <div className="right-notification">
                    <div className="four-images d-flex">{renderImages(item.notificationImages)}</div>
                </div>
            </div>
        </div>
    );
...
const loadIcon = (item) => {
    ...
    if (['PROJECT_STATUS_UPDATED', 'TASK_COMPLETED', 'INVOICE_PAYMENT_APPROVED'].includes(type)) {
        ...
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                    ...
                    stroke-linejoin="round"
                />
                <path d="M12 8V16" stroke="#21242B" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M8 12H16" stroke="#21242B" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        );
        ...
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                    ...
                    stroke-linejoin="round"
                />
                <path d="M1 10H23" stroke="#21242B" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        );
        ...
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M12 1V23" stroke="#21242B" stroke-linecap="round" stroke-linejoin="round" />
                <path
