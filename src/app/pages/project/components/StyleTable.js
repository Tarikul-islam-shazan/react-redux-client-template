               ...
               {data.planData.map((item, index) => (
                  ...
                  >
                     ...
                     <div
                        ...
                        onClick={() => onClickCell(item.values[0].stepId)}
                     >
                        <p>
                           {changeDateFormat(item.values[0].endDate, "YYYY-MM-DD", "MMM-DD")}{" "}
         ...
         <div className="task-buttons">
            {styleData && (
               <DateRangePicker
                  ...
                  onDatesChange={({ startDate, endDate }) => saveDate(startDate, endDate)} // PropTypes.func.isRequired,
