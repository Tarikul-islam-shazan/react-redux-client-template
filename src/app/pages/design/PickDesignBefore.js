...
class PickDesign extends Component {
    ...
    componentDidMount = async() => {
      ...
      let popular = await this.renderList();
      await this.setState({
        sort : 'dateAdded,desc'
      })
      let trending = await this.renderList();
      await this.setState({
        sort : 'boost,desc'
      })
      let nitexSuggestion = await this.renderList();
      await this.setState({
        sort : '',
        popular,
        trending,
      ...
      console.log("nitexSuggestion",nitexSuggestion)
      ...
      Http.POST( 'likeProduct' , {} , id )
        .then(({data}) => {
          ...
          if(data.success){
            ...
            nitexSuggestion = nitexSuggestion.map((item,i) => {
              if(item.id == id){
                item.liked = true;
                return item;
              }
