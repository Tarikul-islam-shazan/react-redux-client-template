...
class ConfirmPayment extends Component {
    ...
    confirm = async () => {
        let id = this.props.match.params.id;
        const type = "Pay now";
        let result = validate(this.state, id, type);
            ...
            <div className="add-quote d-flex">
                <div className="confirm-quote-request placing-order">
                    <div className="header-title d-flex justify-content-between align-items-center">
                        <a href="#">
                            <h3 className="text-black font-26 semibold">Placing order</h3>
                        </a>
                    </div>
                    <div className="mt-3">
                        <input
                    ...
                    <div className="order-step2">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group">
                                        ...
                                        />
                                        {billingNameError ? (
                                            <span className="error">{billingNameError}</span>
                                        ) : (
                                            ""
                                        )}
                                    </div>
                            ...
                            <div className="row">
                                <div className="col-sm-6 col-md-6 col-lg-3">
                                    <div className="form-group">
                                        ...
                                        />
                                        {billingStateError ? (
                                            <span className="error">{billingStateError}</span>
                                        ) : (
                                            ""
                                        )}
                                    </div>
                                ...
                                <div className="col-sm-6 col-md-6 col-lg-3">
                                    <div className="form-group">
                                        ...
                                        />
                                        {billingCityError ? (
                                            <span className="error">{billingCityError}</span>
                                        ) : (
                                            ""
                                        )}
                                    </div>
                                ...
                                <div className="col-sm-6 col-md-6 col-lg-3">
                                    <div className="form-group">
                                        ...
                                        />
                                        {billingPostCodeError ? (
                                            <span className="error">{billingPostCodeError}</span>
                                        ) : (
                                            ""
                                        )}
                                    </div>
                                ...
                                <div className="col-sm-6 col-md-6 col-lg-3">
                                    <div className="form-group">
                                        ...
                                        />
                                        {billingPhoneNumberError ? (
                                            <span className="error">{billingPhoneNumberError}</span>
                                        ) : (
                                            ""
                                        )}
                                    </div>
                                ...
                                <div className="col-md-6 col-lg-5">
                                    <div className="custom-chekbox">
                                        <div className="form-group">
                                            ...
                                            <label
                                                for="1"
                                                className="font-16 color-gray font-weight-normal"
                                            >
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group">
                                        ...
                                        />
                                        {shippingNameError ? (
                                            <span className="error">{shippingNameError}</span>
                                        ) : (
                                            ""
                                        )}
                                    </div>
                                ...
                                <div className="col-md-6">
                                    <div className="form-group">
                                        ...
                                        />
                                        {shippingAddressError ? (
                                            <span className="error">{shippingAddressError}</span>
                                        ) : (
                                            ""
                                        )}
                                    </div>
                            ...
                            <div className="row">
                                <div className="col-sm-6 col-md-6 col-lg-3">
                                    <div className="form-group">
                                        ...
                                        />
                                        {shippingStateError ? (
                                            <span className="error">{shippingStateError}</span>
                                        ) : (
                                            ""
                                        )}
                                    </div>
                                ...
                                <div className="col-sm-6 col-md-6 col-lg-3">
                                    <div className="form-group">
                                        ...
                                        />
                                        {shippingCityError ? (
                                            <span className="error">{shippingCityError}</span>
                                        ) : (
                                            ""
                                        )}
                                    </div>
                                ...
                                <div className="col-sm-6 col-md-6 col-lg-3">
                                    <div className="form-group">
                                        ...
                                        />
                                        {shippingPostCodeError ? (
                                            <span className="error">{shippingPostCodeError}</span>
                                        ) : (
                                            ""
                                        )}
                                    </div>
                        ...
                        <div className="stepper">
                            ...
                            <div className="payment-method-type">
                                ...
                                <div
                                    className={`type bank-slipt ${
                                        paymentMethod === "BANK_SLIP" ? "active" : ""
                                    }`}
                                    onClick={() => this.setPaymentMethod("BANK_SLIP")}
                                >
                                    <svg
                                        id="bank"
                                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="invoice-summary">
                    ...
                    <div className="details">
                        <h4 className="mb-4 color-333 font-20">
                            Invoice No: <strong className="semibold">{invoice.invoiceNo}</strong>
                        </h4>
                        <div className="ordered-container">
                            ...
                            <div className="mt-5 shipping-info">
                                <div className="mb-2 font-weight-normal color-333 font-18">
                                    ...
                                    <div className="mt-4 color-gray font-12 info-text">
                                        Shipping charges and duties might be extra and will be
                                        confirmed before your order is processed.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="submit-for-payment d-flex flex-column align-items-center justify-content-center">
                                ...
                                <a
                                    href
                                    className="font-18 blue pb-2 cursor-pointer"
                                    onClick={this.onPayLater}
                                >
                                    Pay later
                                </a>
                                <a
                                    href
                                    className="font-16 red cursor-pointer"
                                    onClick={this.cancel}
                                >
                                    Cancel order
                                </a>
