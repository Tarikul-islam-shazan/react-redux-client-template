                     ...
                     {projectList.length ? (
                        projectList.map((item, i) => {
                           ...
                           let startDate = item.startDate
                              ? changeDateFormat(item.startDate, "YYYY-MM-DD", "Do MMM, YY")
                              : "";
                           ...
                           return (
                              ...
                              >
                                 <div class="order-images d-flex">
                                    ...
                                    {productList.length < 1 && <div class="single-image"></div>}

                                    {productList.length < 2 && <div class="single-image"></div>}

                                    {productList.length < 3 && <div class="single-image"></div>}

                                    {productList.length < 4 && <div class="single-image"></div>}
                                 </div>
                                             ...
                                             <div class="col-12 pl-0">
                                                <ul class="order-stepper">
                                                   {stageCompletenessList.length ? (
                                                      stageCompletenessList.map((stage, k) => {
                                                         ...
                                                         if (stage.percentageOfCompleteness === 0)
                                                            ...
                                                            stage.percentageOfCompleteness < 100
                                                         )
