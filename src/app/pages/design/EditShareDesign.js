...
class EditShareDesign extends Component {
    ...
    render() {
        let {designDetails, designDocuments, productTypeList, editTitle, editColorAndFabrication, editNotes, editMeasurementChart, showProgressModal, visibleDocType} = this.state;
        return (
          <>
            ...
            <section class="product-img-and-info">
                <div class="product-images d-flex justify-content-between">
                    ...
                    <div class="item">
                        ...
                        <div class="p-img">
                            <img src={require('../../assets/images/tshirt.jpg')} alt=""/>
                            <div class="dlt">
                        ...
                        <div class="more-item font-18 brand-color text-underline mt-2 cursor-pointer" style={{display: 'none'}}>1 more file</div>
                    </div>
                ...
                <div class="product-info d-flex justify-content-between align-items-start flex-column flex-xl-row">
                    ...
                    <div class="product-notes flex-grow-1">
                        ...
                        <MeasurementChart data={designDetails} flag={editMeasurementChart} flagName='editMeasurementChart' toggleFlag={this.toggleFlag} onChange={this.onChange} onSubmit={this.updateNoteAndSize}/>
