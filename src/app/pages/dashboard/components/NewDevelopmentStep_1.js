...
class NewDevelopmentStep_1 extends Component {
    ...
    submit = () => {
        ...
        project.styles.map((item, i) => {
            if (
                item.myDesignList == 0 &&
                item.nitexDesignList == 0 &&
                (item.techPackFile == null || !item.techPackFile.name)
            ) {
                flag = false;
                                            ...
                                            <div className="section-content development-step-1">
                                                                ...
                                                                <div className="card" key={i}>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="form-group">
                                                                            ...
                                                                            <div
                                                                                className="tab-content align-self-center"
                                                                                id="myTabContent"
                                                                            >
                                                                                <div
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <label
                                                                                        className="btn btn-outline-nitex btn-outline"
                                                                                        style={{
                                                                                            display:
                                                                                                "inline",
                                                                                        }}
                                                                        ...
                                                                        <div className="col-lg-12">
                                                                            ...
                                                                            1 ? (
                                                                                <div
                                                                                    className="add-new reduce color"
                                                                                    onClick={() =>
                                                                                        this.removeColorObj(
                                                                                            i
                                                                                        )
                                                                        ...
                                                                        <div className="design-upload">
                                                                            <div className="row align-items-center">
                                                                                <div className="form-group col-sm-12 col-md-12  col-lg-3">
                                                                                    ...
                                                                                    <label
                                                                                        className="btn btn-nitex-default"
                                                                                        style={{
                                                                                            display:
                                                                                                "inline",
                                                                                        }}
                                                                                ...
                                                                                <div className="col-sm-12 col-md-12  col-lg-9">
                                                                                    <div className="form-group">
                                                                                        {item.designInspirationsFiles.map(
                                                                                            (
                                                                                                item,
                                                                                                _key
                                                                                            ) => {
                                                ...
                                                <div className="form-row">
                                                    <div className="col-md-3 ml-auto text-right">
                                                        <button
                                                            className="btn btn-nitex-default btn-block mt-5"
                                                            onClick={this.submit}
                                                        >
                                                            Next
                                                        </button>
